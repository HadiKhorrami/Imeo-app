...
public class GeometryWaste extends Fragment {
    MapView mapView;
    long currRepId;
    ...
    String[] depoWasteNewPoints;
    Polygon poly;
    Double lat,lng;
    long repId,mineId;
    private static final List<List<Point>> POINTS = new ArrayList<>();
    private static final List<Point> OUTER_POINTS = new ArrayList<>();
    private static final List<List<Point>> depoWastePOINTS = new ArrayList<>();
    private static final List<Point> depo_Waste_OUTER_POINTS = new ArrayList<>();
    private static final List<com.google.android.gms.maps.model.LatLng> waste_LatLng_List = new ArrayList<>();
    ConstraintLayout mainLayout;
    public GeometryWaste() {
        // Required empty public constructor
    }


    public static GeometryWaste newInstance() {
        GeometryWaste fragment = new GeometryWaste();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_geometry_waste, container, false);
        btnLocation = view.findViewById(R.id.btnLocation);
        btnSave = view.findViewById(R.id.btnSave);
        btnBack = view.findViewById(R.id.btnBack);
        mainLayout = view.findViewById(R.id.mainLayout);
        mapView = view.findViewById(R.id.wasteMapView);
            ...
            public void onClick(View v) {
                if(isInside == true) {
                    ...
                    try {
                        ...
                        jsonObject.put("geometryDepoWaste", "POINT (" + lng + " " + lat + ")");
                        jsonObject.put("setGeom3", true);
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        if(!mineWkt.equals("")) {
                            ...
                            for (int i = 0; i < points.size(); i++) {
                                ...
                                waste_LatLng_List.add(new com.google.android.gms.maps.model.LatLng(Double.parseDouble(newPoints[1]), Double.parseDouble(newPoints[0])));
                            }
                        ...
                        if (mapboxMap != null && mapboxMap.getStyle() != null) {
                            ...
                            handler.postDelayed(() -> {
                                ...
                                if (locationComponent != null && locationComponent.getLastKnownLocation() != null) {
                                    ...
                                    isInside = PolyUtil.containsLocation(new com.google.android.gms.maps.model.LatLng(lat,lng), waste_LatLng_List, false);
                                }
                            }, 2000);
                        }
                    }
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        /////////////////////////////////////////////////////////
                        if(!report.getGeometrydepowaste().equals("")) {
                            ArrayList<String> jebhPoints = new ArrayList();
                            String s, s1, s2, s3, s4;
                            s = report.getGeometrydepowaste();
                            ...
                            depo_Waste_OUTER_POINTS.clear();
                            depoWastePOINTS.clear();
                            for (int i = 0; i < jebhPoints.size(); i++) {
                                depoWasteNewPoints = jebhPoints.get(i).split(",");
                                depo_Waste_OUTER_POINTS.add(Point.fromLngLat(Double.parseDouble(depoWasteNewPoints[0]), Double.parseDouble(depoWasteNewPoints[1])));
                                depoWastePOINTS.add(depo_Waste_OUTER_POINTS);
                            }

                            final long wasteSourceId, wasteLayerId;
                            wasteSourceId = repId;
                            wasteLayerId = repId;
                            if (style.getSource(String.valueOf(wasteSourceId)) != null) {
                                style.removeLayer(String.valueOf(wasteLayerId));
                                style.removeSource(String.valueOf(wasteSourceId));
                            } else {
                                style.removeLayer(String.valueOf(wasteLayerId));
                                style.addSource(new GeoJsonSource(String.valueOf(wasteSourceId), Polygon.fromLngLats(depoWastePOINTS)));
                                style.addLayerBelow(new FillLayer(String.valueOf(wasteLayerId), String.valueOf(wasteSourceId)).withProperties(

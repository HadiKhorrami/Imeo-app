 ...
 * Use the {@link GeometrySineKar#newInstance} factory method to
 * create an instance of this fragment.
 */
public class GeometrySineKar extends Fragment {
    MapView mapView;
    ...
    String[] newPoints;
    String[] sinekarNewPoints;
    Polygon poly;
    Double lat,lng;
    private static final List<List<Point>> POINTS = new ArrayList<>();
    private static final List<Point> OUTER_POINTS = new ArrayList<>();
    private static final List<List<Point>> sinekarPOINTS = new ArrayList<>();
    private static final List<Point> sinekar_OUTER_POINTS = new ArrayList<>();
    private static final List<com.google.android.gms.maps.model.LatLng> sinekar_LatLng_List = new ArrayList<>();
    ConstraintLayout mainLayout;
    public GeometrySineKar() {
        // Required empty public constructor
    }

    public static GeometrySineKar newInstance() {
        GeometrySineKar fragment = new GeometrySineKar();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_geometry_sine_kar, container, false);
        btnLocation = view.findViewById(R.id.btnLocation);
        btnSave = view.findViewById(R.id.btnSave);
        btnBack = view.findViewById(R.id.btnBack);
        mainLayout = view.findViewById(R.id.mainLayout);
        mapView = view.findViewById(R.id.sineKarMapView);
        getSinekarGeo();
            ...
            public void onClick(View v) {
                if(isInside == true) {
                    ...
                    try {
                        ...
                        jsonObject.put("geometrySinekar", "POINT (" + lng + " " + lat + ")");
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        if(!mineWkt.equals("")) {
                            ...
                            for (int i = 0; i < points.size(); i++) {
                                ...
                                sinekar_LatLng_List.add(new com.google.android.gms.maps.model.LatLng(Double.parseDouble(newPoints[1]), Double.parseDouble(newPoints[0])));
                            }
                        ...
                        if (mapboxMap != null && mapboxMap.getStyle() != null) {
                            ...
                            handler.postDelayed(() -> {
                                ...
                                if (locationComponent != null && locationComponent.getLastKnownLocation() != null) {
                                    ...
                                    isInside = PolyUtil.containsLocation(new com.google.android.gms.maps.model.LatLng(lat,lng), sinekar_LatLng_List, false);
                                }
                            }, 2000);
                        }
                    }
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        LocalizationPlugin localizationPlugin = new LocalizationPlugin(mapView, mapboxMap , style);
                        localizationPlugin.setMapLanguage(MapLocale.LOCAL_NAME);
                        System.out.println("wktCenter = " + wktCenter);
                        if(wktCenter != null) {
                        ...
                        /////////////////////////////////////////////////////////
                        if(!report.getGeometrysinekar().equals("")) {
                            ArrayList<String> jebhPoints = new ArrayList();
                            String s, s1, s2, s3, s4;
                            s = report.getGeometrysinekar();
                            ...
                            sinekar_OUTER_POINTS.clear();
                            sinekarPOINTS.clear();
                            for (int i = 0; i < jebhPoints.size(); i++) {
                                sinekarNewPoints = jebhPoints.get(i).split(",");
                                sinekar_OUTER_POINTS.add(Point.fromLngLat(Double.parseDouble(sinekarNewPoints[0]), Double.parseDouble(sinekarNewPoints[1])));
                                sinekarPOINTS.add(sinekar_OUTER_POINTS);
                            }

                            final long sinekarSourceId, sinekarLayerId;
                            sinekarSourceId = repId;
                            sinekarLayerId = repId;
                            if (style.getSource(String.valueOf(sinekarSourceId)) != null) {
                                style.removeLayer(String.valueOf(sinekarLayerId));
                                style.removeSource(String.valueOf(sinekarSourceId));
                            } else {
                                style.removeLayer(String.valueOf(sinekarLayerId));
                                style.addSource(new GeoJsonSource(String.valueOf(sinekarSourceId), Polygon.fromLngLats(sinekarPOINTS)));
                                style.addLayerBelow(new FillLayer(String.valueOf(sinekarLayerId), String.valueOf(sinekarSourceId)).withProperties(

...
public class GeometryChahak extends Fragment {
    MapView mapView;
    ...
    String[] chahakNewPoints;
    Polygon poly;
    Double lat,lng;
    private static final List<List<Point>> POINTS = new ArrayList<>();
    private static final List<Point> OUTER_POINTS = new ArrayList<>();
    private static final List<List<Point>> chahakPOINTS = new ArrayList<>();
    private static final List<Point> chahak_OUTER_POINTS = new ArrayList<>();
    private static final List<com.google.android.gms.maps.model.LatLng> chahak_LatLng_List = new ArrayList<>();
    ConstraintLayout mainLayout;
    public GeometryChahak() {
        // Required empty public constructor
    }


    public static GeometryChahak newInstance() {
        GeometryChahak fragment = new GeometryChahak();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_geometry_chahak, container, false);
        btnLocation = view.findViewById(R.id.btnLocation);
        btnSave = view.findViewById(R.id.btnSave);
        btnBack = view.findViewById(R.id.btnBack);
        mainLayout = view.findViewById(R.id.mainLayout);
        mapView = view.findViewById(R.id.chahakMapView);
        getChahakGeo();
            ...
            public void onClick(View v) {
                if(isInside == true) {
                    ...
                    try {
                        ...
                        jsonObject.put("geometryWell", "POINT (" + lng + " " + lat + ")");
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        if(!mineWkt.equals("")) {
                            ...
                            for (int i = 0; i < points.size(); i++) {
                                ...
                                chahak_LatLng_List.add(new com.google.android.gms.maps.model.LatLng(Double.parseDouble(newPoints[1]), Double.parseDouble(newPoints[0])));
                            }
                        ...
                        if (mapboxMap != null && mapboxMap.getStyle() != null) {
                            ...
                            handler.postDelayed(() -> {
                                ...
                                if (locationComponent != null && locationComponent.getLastKnownLocation() != null) {
                                    ...
                                    isInside = PolyUtil.containsLocation(new com.google.android.gms.maps.model.LatLng(lat,lng), chahak_LatLng_List, false);
                                }
                            }, 2000);
                        }
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        /////////////////////////////////////////////////////////
                        if(!report.getGeometrywell().equals("")) {
                            ArrayList<String> jebhPoints = new ArrayList();
                            String s, s1, s2, s3, s4;
                            s = report.getGeometrywell();
                            ...
                            chahak_OUTER_POINTS.clear();
                            chahakPOINTS.clear();
                            for (int i = 0; i < jebhPoints.size(); i++) {
                                chahakNewPoints = jebhPoints.get(i).split(",");
                                chahak_OUTER_POINTS.add(Point.fromLngLat(Double.parseDouble(chahakNewPoints[0]), Double.parseDouble(chahakNewPoints[1])));
                                chahakPOINTS.add(chahak_OUTER_POINTS);
                            }

                            final long chahakSourceId, chahakLayerId;
                            chahakSourceId = repId;
                            chahakLayerId = repId;
                            if (style.getSource(String.valueOf(chahakSourceId)) != null) {
                                style.removeLayer(String.valueOf(chahakLayerId));
                                style.removeSource(String.valueOf(chahakSourceId));
                            } else {
                                style.removeLayer(String.valueOf(chahakLayerId));
                                style.addSource(new GeoJsonSource(String.valueOf(chahakSourceId), Polygon.fromLngLats(chahakPOINTS)));
                                style.addLayerBelow(new FillLayer(String.valueOf(chahakLayerId), String.valueOf(chahakSourceId)).withProperties(

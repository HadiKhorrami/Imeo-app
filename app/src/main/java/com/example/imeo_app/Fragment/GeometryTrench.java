...
public class GeometryTrench extends Fragment {
    MapView mapView;
    ...
    String[] trenchNewPoints;
    Polygon poly;
    Double lat,lng;
    private static final List<List<Point>> POINTS = new ArrayList<>();
    private static final List<Point> OUTER_POINTS = new ArrayList<>();
    private static final List<List<Point>> trenchPOINTS = new ArrayList<>();
    private static final List<Point> trench_OUTER_POINTS = new ArrayList<>();
    private static final List<com.google.android.gms.maps.model.LatLng> trench_LatLng_List = new ArrayList<>();
    ConstraintLayout mainLayout;
    public GeometryTrench() {
        // Required empty public constructor
    }

    public static GeometryTrench newInstance() {
        GeometryTrench fragment = new GeometryTrench();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_geometry_trench, container, false);
        btnLocation = view.findViewById(R.id.btnLocation);
        btnSave = view.findViewById(R.id.btnSave);
        btnBack = view.findViewById(R.id.btnBack);
        mainLayout = view.findViewById(R.id.mainLayout);
        mapView = view.findViewById(R.id.trenchMapView);
        getTrenchGeo();
            ...
            public void onClick(View v) {
                if(isInside == true) {
                    ...
                    try {
                        ...
                        jsonObject.put("geometryTrench", "POINT (" + lng + " " + lat + ")");
                        jsonObject.put("setGeom2", true);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        if(!mineWkt.equals("")) {
                            ...
                            for (int i = 0; i < points.size(); i++) {
                                ...
                                trench_LatLng_List.add(new com.google.android.gms.maps.model.LatLng(Double.parseDouble(newPoints[1]), Double.parseDouble(newPoints[0])));
                            }
                        ...
                        if (mapboxMap != null && mapboxMap.getStyle() != null) {
                            ...
                            handler.postDelayed(() -> {
                                if (locationComponent != null && locationComponent.getLastKnownLocation() != null) {
                                    ...
                                    isInside = PolyUtil.containsLocation(new com.google.android.gms.maps.model.LatLng(lat,lng), trench_LatLng_List, false);
                                }
                            }, 2000);
                        }
            ...
            public void onMapReady(@NonNull MapboxMap mapboxMap) {
                mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        /////////////////////////////////////////////////////////
                        if(!report.getGeometrytrench().equals("")) {
                            ArrayList<String> jebhPoints = new ArrayList();
                            String s, s1, s2, s3, s4;
                            s = report.getGeometrytrench();
                            ...
                            trench_OUTER_POINTS.clear();
                            trenchPOINTS.clear();
                            for (int i = 0; i < jebhPoints.size(); i++) {
                                trenchNewPoints = jebhPoints.get(i).split(",");
                                trench_OUTER_POINTS.add(Point.fromLngLat(Double.parseDouble(trenchNewPoints[0]), Double.parseDouble(trenchNewPoints[1])));
                                trenchPOINTS.add(trench_OUTER_POINTS);
                            }
                            ...
                            if (style.getSource(String.valueOf(sinekarSourceId)) != null) {
                                ...
                                style.removeLayer(String.valueOf(sinekarLayerId));
                                style.addSource(new GeoJsonSource(String.valueOf(sinekarSourceId), Polygon.fromLngLats(trenchPOINTS)));
